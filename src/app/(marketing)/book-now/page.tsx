  ...
  return (
    <div className="modal-overlay">
      <div className="modal-box">
        ...
        {bookingId && (
          <p className="modal-sub" style={{ fontSize: 11, color: "var(--text-3)" }}>
...
function OrderSummary({
  ...
  const handleBookingSubmit = onConfirm;
...
function BookNowInner() {
  ...
  async function handleBookingSubmit() {
    if (!form.selectedDrip || !form.date || !form.timeSlot || !form.location) {
    ...
    try {
      ...
      const scheduledAt = new Date(year, month - 1, day, hour24, minutes).toISOString();

      const res = await fetch("/api/bookings", {
        method: "POST",
        headers,
        body: JSON.stringify({
          dripId: form.selectedDrip.id,
          scheduledAt,
          location: form.location,
          address: form.location === "home" ? "" : "",
          notes: form.notes,
    ...
    try {
      const res = await fetch("/api/clinic-enquiry", {
        ...
        body: JSON.stringify({
          ...
          contactName: clinicForm.contactName,
          contactEmail: clinicForm.contactEmail,
          contactPhone: clinicForm.contactPhone,
          orderType: clinicForm.orderType,
          formulas: clinicForm.formulas,
          qty: clinicForm.qty,
          address: clinicForm.address,
          instructions: clinicForm.instructions,
        }),
      });
      ...
      setError("Network error. Please try again.");
      console.error("Clinic enquiry error:", err);
    } finally {
      setSubmitting(false);
    }
  }
      ...
      <div className="page-wrap">
        ...
        {activeTab === "individual" && (
          <div className="booking-layout">
            ...
            <OrderSummary form={form} onConfirm={handleBookingSubmit} submitting={submitting} />
          </div>
        )}
              ...
              {clinicDone ? (
                ...
                <>
                  ...
                  <div className="clinic-field-group">
                    ...
                    <button className="clinic-submit-btn" onClick={handleClinicSubmit} disabled={submitting}>
